...
# COMPS=(1 5 10 25 50 75 100 125 150 165 175 185 195 205)
...
mpirun -n ${r} python ${FUNCTION_PATH} -e xpptut15 -r 580 -d jungfrau4M --components ${q} --benchmark_mode --output_dir ${OUTPUT_DIR}
